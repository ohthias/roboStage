...
export default function RegisterPage() {
  ...
  return (
    ...
    <div className="max-w-md mx-auto my-10 bg-light-smoke p-6 rounded shadow-md">
      <h1 className="text-4xl font-bold text-center text-red-600">Junte-se!</h1>
      <p className="text-center mb-4 text-gray-600">Crie sua conta agora! <a href="/login" className="text-red-600">Já tenho uma conta</a></p>
