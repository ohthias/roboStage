...
const ResultScreen: React.FC<ResultScreenProps> = ({
  ...
  const successRate = Math.round(
    ((totalQuestions - flaggedCount) / totalQuestions) * 100,
  );
  ...
  return (
    <div className="max-w-lg mx-auto text-center h-[75vh]">
      ...
      <div className="card bg-base-100 p-8 rounded-2xl shadow-xl border border-base-200">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="p-4 bg-base-100 rounded-xl border border-base-200">
            ...
            <div className="text-xs text-base-content/60 uppercase tracking-wide mt-1">
              Total
            </div>
          </div>
          <div className="p-4 bg-error/10 rounded-xl border border-error">
            ...
            <div className="text-xs text-error/80 uppercase tracking-wide mt-1">
              Para Revisar
            </div>
          </div>
        </div>
