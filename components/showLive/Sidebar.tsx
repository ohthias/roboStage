...
export default function Sidebar({ code_volunteer, code_visitor, open, setOpen }: NavigationBarProps) {
    const router = useRouter();

    return (
        <>
            <button
                className="btn btn-primary fixed top-4 left-4 z-50 lg:hidden"
